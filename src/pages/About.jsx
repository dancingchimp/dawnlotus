  ...
  return (
    <div className="min-h-screen bg-stone-900 py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Teacher Bio (For future expansion) */}
        <div className="mb-16">
          <h2 className="text-2xl font-serif text-gold-500 mb-8 text-center">Our Teachers</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-stone-800/30 p-6 rounded-xl border border-jade-500/10 
                         hover:border-jade-500/30 transition-all duration-300 flex gap-6">
              <div className="w-24 h-24 rounded-full overflow-hidden flex-shrink-0">
                <img src="/api/placeholder/96/96" alt="Master Chen" className="w-full h-full object-cover" />
              </div>
              <div>
                <div className="mb-2">
                  <h3 className="text-xl font-serif text-gold-500">Master Chen</h3>
                  <p className="text-stone-400 font-chinese">陳</p>
                </div>
                <p className="text-stone-300 text-sm mb-3">
                  Master Chen has over 25 years of experience in traditional Daoist practices, 
                  including Qigong, Tai Chi, and internal alchemy. He bridges traditional Chinese 
                  arts with contemporary teaching methods.
                </p>
                <div className="text-jade-500 text-sm font-medium">
                  Daoist Yoga, Qigong, Theory
                </div>
              </div>
            </div>
            <div className="bg-stone-800/30 p-6 rounded-xl border border-jade-500/10 
                         hover:border-jade-500/30 transition-all duration-300 flex gap-6">
              <div className="w-24 h-24 rounded-full overflow-hidden flex-shrink-0">
                <img src="/api/placeholder/96/96" alt="Master Liu" className="w-full h-full object-cover" />
              </div>
              <div>
                <div className="mb-2">
                  <h3 className="text-xl font-serif text-gold-500">Master Liu</h3>
                  <p className="text-stone-400 font-chinese">劉</p>
                </div>
                <p className="text-stone-300 text-sm mb-3">
                  Master Liu specializes in meditation and internal cultivation practices from the 
                  Daoist tradition. Her approach emphasizes the subtle aspects of energy work and 
                  spiritual development.
                </p>
                <div className="text-jade-500 text-sm font-medium">
                  Meditation, Energy Cultivation, Inner Alchemy
                </div>
              </div>
            </div>
          </div>
