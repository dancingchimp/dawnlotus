      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-stone-300 max-w-3xl mx-auto">
            ...
            creating a complete system for physical opening, energetic cultivation, and spiritual transformation.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="bg-stone-800/30 p-8 rounded-xl border border-jade-500/10 
            ...
            <div className="mb-6">
              <h4 className="text-xl font-serif text-gold-500 mb-2">Physical Opening</h4>
              <p className="text-stone-400 font-chinese">身體開放</p>
            </div>
            <p className="text-stone-300 mb-6">
              Western yoga postures are strategically sequenced to open specific meridian pathways, 
              preparing the body for deeper energy work while building strength and flexibility.
            </p>
            <div className="bg-stone-900/30 p-4 rounded-lg">
              <p className="text-jade-400 text-sm italic">
                ...
                Without proper preparation, deeper practices cannot take root."
              </p>
            </div>
          </div>
          ...
          <div className="bg-stone-800/30 p-8 rounded-xl border border-jade-500/10 
            ...
            <p className="text-stone-300 mb-6">
              ...
              build, direct, and refine energy through the body's meridian system.
            </p>
            <div className="bg-stone-900/30 p-4 rounded-lg">
              <p className="text-jade-400 text-sm italic">
                "Qi follows intention. When the channels are open and the mind is focused,
                energy naturally flows and accumulates."
              </p>
            </div>
          </div>
